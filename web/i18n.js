...
const TRANSLATIONS = {
    ...
    ru: {
        ...
        detail_not_found: "Это объявление не найдено — вероятно, удалено из источника.",
    ...
    kk: {
        ...
        detail_not_found: "Бұл хабарландыру табылмады — бәлкім дереккөзден жойылған.",
        detail_open_source: "Дереккөз",
        notfound_msg: "Бет табылмады.",
        notfound_home: "Басты бетке өту",
        detail_gallery: "Суреттер",
